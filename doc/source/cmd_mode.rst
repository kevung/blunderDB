...
.. csv-table::
   ...
   "E>x", "L'erreur du coup joué (en millipoints) est supérieure à x."
   "E<x", "L'erreur du coup joué (en millipoints) est inférieure à x."
   "Ex,y", "L'erreur du coup joué (en millipoints) est comprise entre x et y."
