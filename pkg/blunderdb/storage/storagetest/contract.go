...
func RunContractTests(t *testing.T, factory func() storage.Storage) {
	...
	cases := []struct {
		...
		{"Position/RepairCrawfordSentinelOnePointMatch", testRepairCrawfordSentinelOnePointMatch},
		...
		{"Analysis/WithoutAnalysisIsTheGapRule", testWithoutAnalysis},
		...
		{"Positions/SimilarRanksAgainstADrawnBoard", testSimilarRanksAgainstADrawnBoard},
