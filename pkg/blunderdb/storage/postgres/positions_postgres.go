...
func (s *positionStore) Similar(ctx context.Context, scope string, target *domain.Position, opts storage.SimilarOptions) ([]storage.SimilarPosition, error) {
	return sqlshared.Similar(ctx, s.shared, scope, target, opts)
}
