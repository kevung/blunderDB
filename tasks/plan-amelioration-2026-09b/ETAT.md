...
fusionnées : B.8 (codes de retour et sortie machine de la CLI), C.5 (question de modèle
à porter en amont dans gammonNet, tranchée par P6), D.3, D.4, D.5 (parseur de recherche
