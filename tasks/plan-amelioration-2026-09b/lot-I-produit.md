...
### I.1 — Rapport de fin d'import [M] — tous — valeur haute
...
### I.2 — Dossier surveillé [M] — compét, coach — valeur haute
...
### I.3 — File d'étude post-import [M] — compét — valeur haute
...
### I.4 — Import OGXM et codec OGID (rouvre #114) [M] — compét, dev — valeur haute
...
### I.5 — Presse-papier Heroes (rouvre #61) [S/M] — club — valeur moyenne-haute
...
### I.6 — Coller un identifiant et enrichir un match depuis un fichier [S] — club, coach
...
### I.7 — Provenance et pluralité des commentaires [M, schéma] — compét, coach
...
### I.8 — Phase de partie [S/M] — tous — valeur moyenne, effort minime
...
### I.9 — Vocabulaire de tags et panneau Tags [M] — club, coach — valeur haute
...
### I.10 — Stats ventilées : phase, catégorie, score [M] — compét — valeur haute
...
### I.11 — Matrice du videau par score [M] — compét, coach — valeur très haute
...
### I.12 — Un PR sur les matchs sans analyse [M] — compét — valeur très haute
...
### I.13 — Comparaison inter-moteurs sur une position [M] — compét, dev
...
### I.14 — Ce que vaut l'évaluateur : #127 et le rapport sur sa propre base [S/M] — compét
...
### I.15 — Drapeaux de règles visibles, MET configurable [S puis M] — compét
...
### I.16 — 3-ply mesuré et exposé [S] — compét
...
### I.17 — Micro-entraînements : pips, EPC, points de prise [S/M] — club — premier module
...
### I.18 — Objectifs de progression [M] — compét
...
### I.19 — Statistiques d'étude corrélées au jeu réel [M] — compét
...
### I.22 — Un seul rendu du plateau, export image fichier [S] — tous
...
### I.23 — Rapport de session / match / tournoi en HTML [M] — compét, coach
...
### I.24 — Export CSV/Parquet et notebook d'exemple [S/M] — dev, compét
...
### I.25 — Index communautaire de bases filigranées [S] — coach, club
...
### I.26 — Collections vivantes, « vue N fois », deux joueurs côte à côte [M] — compét, coach
...
### I.27 — Grammaire d'intentions dans la ligne de commande [M] — club
...
### I.28 — Écran d'accueil et onboarding orienté valeur [M] — club — valeur très haute
...
### I.29 — Corbeille et annulation [M] — tous
...
### I.30 — Thèmes nommés : clair, sombre, contraste élevé, imprimable [M] — tous
Après D.9 (tokens). Le plateau two.js lit les tokens ; export/import d'un
thème ; `prefers-color-scheme` par défaut.

### I.31 — Confort d'usage quotidien [S chacune] — tous
...
### I.32 — Fusionner deux bases, et dire la vérité sur la synchronisation [S] — compét
...
### I.33 — API stable et client minimal [M] — dev
...
### I.34 — Capacités serveur-seules remontées dans l'application [M] — compét
