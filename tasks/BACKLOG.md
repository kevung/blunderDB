...
- **Bug `CommitImportDatabase` : colonnes scalaires NULL** (découvert en
  fiche 04 du plan 2026-08) : le chemin legacy d'import de `.db` insère une
  position « neuve » sans remplir les colonnes scalaires de recherche, ce qui
  casse sa propre déduplication au second import et rend ces positions
  invisibles aux filtres SQL. Perte silencieuse côté utilisateur. Effort
  S/M — promu en lot 0 du plan 2026-09 (0.4).
