...
| P3 | Postgres backend | [03-postgres-backend.md](03-postgres-backend.md) | 10-15 d | high | PR1 done (skeleton: pgx/pgxpool, `001_initial_v2_7_0.sql`, bootstrap, 14 family stubs, testcontainers migration test); PRs 2-8 pending |
