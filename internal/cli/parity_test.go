...
var databaseParity = map[string]parityEntry{
	...
	"AttachMatchToSlot":                 {Why: whyDirection},
	"DetachMatchFromSlot":               {Why: whyDirection},
	"SlotOfMatch":                       {Why: whyDirection},
	"Slots":                             {Why: whyDirection},
	...
	"Standings":                         {Why: whyDirection},
	"StandingsCSV":                      {Why: whyDirection},
	...
	"StartMatchManually":                {Why: whyDirection},
	...
	"WriteDirectionPage":                {Why: whyDirection},
	...
	"DirectionJournalJSON":              {Why: whyDirection},
