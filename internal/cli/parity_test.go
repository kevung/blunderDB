...
var databaseParity = map[string]parityEntry{
	...
	// The .mat pane of the panel: the same renderer the library's matches go
	// through, shown as a view of the export. It writes nothing, and it reads a
	// draft, so it is a transcription binding like the others.
