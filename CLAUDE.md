...
- Top-level `*.md` files like `ANALYSIS_IMPLEMENTATION.md`, `MATCH_IMPORT_ARCHITECTURE.md`, `POSITION_TRACKING_IMPLEMENTATION.md`, `DISPLAY_FIX_SUMMARY.md`, `MATCH_MODE_DISPLAY_IMPLEMENTATION.md`, `PLAYED_MOVE_INDICATOR.md`, `XG_PLAYER_ENCODING_FIX.md` are historical design/implementation notes — consult them when touching the related subsystem but don't assume they reflect current code.
