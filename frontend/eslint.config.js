...
export default [
    ...
    {
        // src/i18n/help/*.js are generated by cmd/help-gen (make help): each
        // exports a single multi-KB HTML template-literal string per help tab.
        // They parse fine at runtime (node/Vite) but exceed eslint's espree
        // parser limits, so we skip linting them — they contain no logic to
        // lint. What the exclusion used to hide (fiche D.15: an unescaped
        // interpolation in the About tab) is covered instead by
        // src/__tests__/help.safety.test.js, which inspects the shipped corpus
