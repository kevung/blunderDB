...
export namespace domain {
	...
	export class IssuanceInfo {
	    ...
	    static createFrom(source: any = {}) {
	        return new IssuanceInfo(source);
	    }
...
export namespace gammonnet {
	...
	export class CubeMatrixCell {
	    ...
	    static createFrom(source: any = {}) {
	        return new CubeMatrixCell(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.noDouble = source["noDouble"];
	        this.doubleTake = source["doubleTake"];
	        this.doublePass = source["doublePass"];
	        this.refused = source["refused"];
	        this.reason = source["reason"];
	    }
	}
	export class CubeMatrix {
	    matchLength: number;
	    ply: number;
	    cells: CubeMatrixCell[];
	
	    static createFrom(source: any = {}) {
	        return new CubeMatrix(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.matchLength = source["matchLength"];
	        this.ply = source["ply"];
	        this.cells = this.convertValues(source["cells"], CubeMatrixCell);
	    }
...
export namespace parser {
	...
	export class Result {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.analysis = this.convertValues(source["analysis"], domain.PositionAnalysis);
	        this.comment = source["comment"];
	    }
...
export namespace storage {
	...
	export class SimilarPosition {
	    ...
	    static createFrom(source: any = {}) {
	        return new SimilarPosition(source);
	    }
	...
	export class TrainingNumberStat {
	    ...
	    static createFrom(source: any = {}) {
	        return new TrainingNumberStat(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.deviations = source["deviations"];
	...
	export class TrainingSession {
	    ...
	    static createFrom(source: any = {}) {
	        return new TrainingSession(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.seedSource = source["seedSource"];
	        this.createdAt = source["createdAt"];
	        this.numbersAsked = source["numbersAsked"];
	        this.faults = source["faults"];
	        this.deviations = source["deviations"];
	        this.meanDeviation = source["meanDeviation"];
