...
export function GetCommentsByPosition(arg1:number):Promise<Array<main.CommentEntry>>;
...
export function SearchComments(arg1:string):Promise<Array<main.CommentEntry>>;
