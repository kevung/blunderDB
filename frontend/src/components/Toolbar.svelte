...
<div class="toolbar">
    ...
    <button on:click|stopPropagation={onCopyPosition} aria-label="Copy Position" title={isSearchTab ? 'Copy Position to clipboard and board clipboard (Ctrl-C)' : 'Copy Position (Ctrl-C)'} disabled={!databasePath}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
