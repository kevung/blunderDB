...
<div class="toolbar">
    ...
    <button on:click|stopPropagation={handleImportPosition} aria-label="Import Position or Match" title="Import Position or Match (Ctrl-I)" disabled={statusBarMode === 'EDIT' || !databasePath}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
