<script>
    ...
    export let onToggleMatchMode; // Add export for match mode
    ...
    function handleImportFolder() {
        if (statusBarMode === 'EDIT') {
            console.error('Cannot import folder in edit mode');
            setStatusBarMessage('Cannot import folder in edit mode');
        } else {
            onImportFolder();
        }
    }
...
<div class="toolbar">
    ...
    <button on:click|stopPropagation={handleImportPosition} aria-label="Import Position or Match" title="Import Position or Match Files (Ctrl-I)" disabled={statusBarMode === 'EDIT' || !databasePath}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m3.75 9v6m3-3H9m1.5-12H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
        </svg>
    </button>

    <button on:click|stopPropagation={handleImportFolder} aria-label="Import Folder" title="Import Folder (Ctrl-Shift-F)" disabled={statusBarMode === 'EDIT' || !databasePath}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 10.5v6m3-3H9m4.06-7.19-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z" />
        </svg>
    </button>
    ...
    <button on:click|stopPropagation={handleGoToPosition} aria-label="Go To Position" title="Go To Position" disabled={statusBarMode !== 'NORMAL' || !databasePath}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <button on:click|stopPropagation={onTogglePipcount} aria-label="Toggle Pipcount" title="Toggle Pipcount (p)" disabled={(statusBarMode !== 'NORMAL' && statusBarMode !== 'MATCH') || !databasePath}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <button on:click|stopPropagation={onToggleMatchMode} aria-label="Match Mode" title="Match Mode (Ctrl+Tab)" disabled={!databasePath}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <button on:click|stopPropagation={onToggleCollectionPanel} aria-label="Collection Panel" title="Collection Panel (Ctrl-K)" disabled={!databasePath}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <button on:click|stopPropagation={onToggleTournamentPanel} aria-label="Tournaments" title="Tournaments (Ctrl-Y)" disabled={!databasePath}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
