<script>
    ...
    let pipCountOption = 'min';
    let pipCountMin = -375;
    let pipCountMax = 375;
    let pipCountRangeMin = -375;
    let pipCountRangeMax = 375;
    let winRateOption = 'min';
    let winRateMin = 0;
    let winRateMax = 100;
    let winRateRangeMin = 0;
    let winRateRangeMax = 100;
    let gammonRateOption = 'min';
    let gammonRateMin = 0;
    let gammonRateMax = 100;
    let gammonRateRangeMin = 0;
    let gammonRateRangeMax = 100;
    let backgammonRateOption = 'min';
    let backgammonRateMin = 0;
    let backgammonRateMax = 100;
    let backgammonRateRangeMin = 0;
    let backgammonRateRangeMax = 100;
    let player2WinRateOption = 'min';
    let player2WinRateMin = 0;
    let player2WinRateMax = 100;
    let player2WinRateRangeMin = 0;
    let player2WinRateRangeMax = 100;
    let player2GammonRateOption = 'min';
    let player2GammonRateMin = 0;
    let player2GammonRateMax = 100;
    let player2GammonRateRangeMin = 0;
    let player2GammonRateRangeMax = 100;
    let player2BackgammonRateOption = 'min';
    let player2BackgammonRateMin = 0;
    let player2BackgammonRateMax = 100;
    let player2BackgammonRateRangeMin = 0;
    let player2BackgammonRateRangeMax = 100;
    let player1CheckerOffOption = 'min';
    let player1CheckerOffMin = 0;
    let player1CheckerOffMax = 15;
    let player1CheckerOffRangeMin = 0;
    let player1CheckerOffRangeMax = 15;
    let player2CheckerOffOption = 'min';
    let player2CheckerOffMin = 0;
    let player2CheckerOffMax = 15;
    let player2CheckerOffRangeMin = 0;
    let player2CheckerOffRangeMax = 15;
    let player1BackCheckerOption = 'min';
    let player1BackCheckerMin = 0;
    let player1BackCheckerMax = 15;
    let player1BackCheckerRangeMin = 0;
    let player1BackCheckerRangeMax = 15;
    let player2BackCheckerOption = 'min';
    let player2BackCheckerMin = 0;
    let player2BackCheckerMax = 15;
    let player2BackCheckerRangeMin = 0;
    let player2BackCheckerRangeMax = 15;
    let player1CheckerInZoneOption = 'min';
    let player1CheckerInZoneMin = 0;
    let player1CheckerInZoneMax = 15;
    let player1CheckerInZoneRangeMin = 0;
    let player1CheckerInZoneRangeMax = 15;
    let player2CheckerInZoneOption = 'min';
    let player2CheckerInZoneMin = 0;
    let player2CheckerInZoneMax = 15;
    let player2CheckerInZoneRangeMin = 0;
    let player2CheckerInZoneRangeMax = 15;
    let player1AbsolutePipCountOption = 'min';
    let player1AbsolutePipCountMin = 0;
    let player1AbsolutePipCountMax = 375;
    let player1AbsolutePipCountRangeMin = 0;
    let player1AbsolutePipCountRangeMax = 375;
    let equityOption = 'min';
    let equityMin = -1000;
    let equityMax = 1000;
    let equityRangeMin = -1000;
    let equityRangeMax = 1000;
    let moveErrorOption = 'min';
    let moveErrorMin = 0;
    let moveErrorMax = 1000;
    let moveErrorRangeMin = 0;
    let moveErrorRangeMax = 1000;
    let player1OutfieldBlotOption = 'min';
    let player1OutfieldBlotMin = 0;
    let player1OutfieldBlotMax = 15;
    let player1OutfieldBlotRangeMin = 0;
    let player1OutfieldBlotRangeMax = 15;
    let player2OutfieldBlotOption = 'min';
    let player2OutfieldBlotMin = 0;
    let player2OutfieldBlotMax = 15;
    let player2OutfieldBlotRangeMin = 0;
    let player2OutfieldBlotRangeMax = 15;
    let player1JanBlotOption = 'min';
    let player1JanBlotMin = 0;
    let player1JanBlotMax = 15;
    let player1JanBlotRangeMin = 0;
    let player1JanBlotRangeMax = 15;
    let player2JanBlotOption = 'min';
    let player2JanBlotMin = 0;
    let player2JanBlotMax = 15;
    let player2JanBlotRangeMin = 0;
    let player2JanBlotRangeMax = 15;
    let creationDateOption = 'min';
    let creationDateMin = '';
    let creationDateMax = '';
    let creationDateRangeMin = '';
    let creationDateRangeMax = '';
