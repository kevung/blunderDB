...
<p>Korrigieren heißt auf der Zelle tippen, auf der man steht. Steht der Cursor auf einer Aktion, beginnt eine Ziffer deren Wurf an Ort und Stelle neu, und auch die vier Dopplerhandlungen gelten als Korrekturen: Auf einer Aufgabe schreibt <em>t</em> — oder die Schaltfläche <strong>Annehmen</strong> — eine Annahme <strong>anstelle</strong> der Aufgabe, ohne sie löschen und dann einfügen zu müssen. Die Partie nimmt dann ihren Lauf wieder auf, und der Rest des Entwurfs wird neu abgespielt. Dieselben Tasten füllen die Zelle, die eine Einfügung gerade geöffnet hat: <em>i</em> und dann <em>d</em> fügt eine Verdopplung vor der angezielten Aktion ein.</p>
...
<p>Eine <strong>Einfügung mitten im Dokument fügt weiter ein</strong>: die Bestätigung öffnet dahinter eine leere Zelle, und die nächste Aktion wird ihrerseits eingefügt, statt die folgende zu überschreiben. Das ist es, was erlaubt, das ganze Ende einer Partie nachzutragen — eine Aufgabe, die eine Annahme hätte sein sollen —, ohne zu verlieren, was von der folgenden Partie schon eingegeben wurde. Den Cursor zu bewegen beendet die Einfügung.</p>
...
<tr>
<td>t</td>
<td>Die angebotene Verdopplung annehmen: der Dopplerwürfel geht zum verdoppelten Wert an den Annehmenden, und der Verdoppelnde würfelt erneut. Steht der Cursor auf einer Zelle, wird die Annahme anstelle der angezielten Aktion geschrieben.</td>
</tr>
<tr>
<td>p</td>
...
<p>Die Ziffer hat eine einzige Bedeutung: <strong>sie beginnt einen Wurf dort, wo der Cursor ist</strong>. Am Ende des Dokuments ist nichts unter dem Cursor, also bestätigt sie den ausgewählten Zug, bevor sie den nächsten Wurf öffnet — der beste gespielte Zug kostet damit die beiden Würfel und nicht mehr, seine Bestätigung wird von der ersten Taste des folgenden Zuges getragen. Bei einer bereits geschriebenen Aktion, zu der man zur Korrektur zurückgekehrt ist, steht etwas unter dem Cursor: die Ziffer beginnt den Wurf dieser Aktion an Ort und Stelle neu. Der Unterschied ist auf dem Bildschirm zu sehen, denn die angezielte Zelle ist im Transkript umrahmt.</p>
...
<p>Eine Einfügung mitten im Dokument fügt weiter ein: die Bestätigung öffnet dahinter eine leere Zelle, und die nächste Aktion wird ihrerseits eingefügt, statt die folgende zu überschreiben. Den Cursor zu bewegen beendet das.</p>
