...
<ul>
<li>die <strong>Übung</strong> — <em>Scores</em>, <em>Pions</em> (Punktzahl) oder <em>Bearoff</em>;</li>
...
<p><code>train scores</code>, <code>train pips</code> und <code>train bearoff</code> öffnen das Panel und starten sofort; <code>train tp</code> und <code>train takepoint</code> sind Synonyme von <code>train scores</code>, <code>train epc</code> von <code>train bearoff</code>.</p>
<h4>Die drei Übungen</h4>
...
<h3>Mikro-Training: das Quiz</h3>
<p>Eine Übung wird noch über die Tastatur beantwortet, in einer Leiste über dem Brett: <code>train quiz</code> startet eine Sitzung mit fünf Fragen. Die Frage IST die angezeigte Stellung — das Brett ist das der Anwendung, und die Leiste trägt nur die Frage, die Eingabe und die Korrektur. <em>Eingabe</em> prüft und geht dann weiter, <em>Esc</em> verlässt die Sitzung.</p>
<p>Nur die Zusammenfassung der Sitzung wird in den Metadaten der Datenbank aufbewahrt: sie hält keine Spur Frage für Frage fest, und nichts wird geschrieben, solange sie nicht beendet ist. Ein Abbruch unterwegs zeichnet also nichts auf.</p>
<p>Das Anki-Panel lässt auswendig lernen; das Quiz <strong>prüft</strong>. Fünf bereits analysierte Stellungen werden aus der durchsuchten Liste gezogen, und es muss entschieden werden:</p>
<ul>
