...
<p>Corregir es teclear en la celda donde se está. Con el cursor sobre una acción, una cifra vuelve a empezar su tirada en el sitio, y las cuatro acciones de cubo valen también como correcciones: sobre un rechazo, <em>t</em> — o el botón <strong>Aceptar</strong> — escribe una aceptación <strong>en lugar</strong> del rechazo, sin tener que borrarlo y luego insertar. La partida retoma entonces su curso y el resto del borrador se vuelve a reproducir. Las mismas teclas rellenan la celda que acaba de abrir una inserción: <em>i</em> y luego <em>d</em> inserta un doble delante de la acción señalada.</p>
...
<tr>
<td>t</td>
<td>Aceptar el doble ofrecido: el cubo pasa al que acepta con el valor doblado y el que dobló vuelve a tirar. Con el cursor sobre una celda, escribe la aceptación en lugar de la acción señalada.</td>
</tr>
<tr>
<td>p</td>
...
<p>Una inserción en medio del documento sigue insertando: la validación abre una celda vacía a continuación, y la acción siguiente se inserta a su vez en lugar de sobrescribir la de después. Mover el cursor le pone fin.</p>
