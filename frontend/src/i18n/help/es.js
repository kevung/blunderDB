...
<p>Volver a introducir los dos dados en la celda de <strong>apertura</strong> de una partida decide de nuevo quién empieza: el dado del jugador 1 se teclea primero, el del jugador 2 después, y gana el mayor — el dado grande primero, el turno va al jugador 1, abajo en el tablero; el pequeño primero, va al jugador 2, arriba. La validación es inmediata con el segundo dado, como para una apertura nueva. El primer movimiento de fichas de la partida, en cambio, conserva el bando que tenía: si ahora corresponde al otro jugador, la transcripción lo marca y el cursor se coloca en él, donde <em>s</em> lo da al bando correcto.</p>
...
<td>Volver a introducir la tirada de apertura: dado del jugador 1 y luego del jugador 2, registrados con el segundo dado. Gana el mayor — el dado grande primero, el turno va al jugador 1 abajo; el pequeño primero, al jugador 2 arriba.</td>
</tr>
<tr>
<td>ABAJO, j</td>
