...
<ul>
<li>el <strong>ejercicio</strong> — <em>Scores</em>, <em>Pions</em> (recuento), <em>Bearoff</em> o <em>Décision</em>;</li>
...
<p><code>train scores</code>, <code>train pips</code>, <code>train bearoff</code> y <code>train decision</code> abren el panel y arrancan directamente; <code>train tp</code> y <code>train takepoint</code> son sinónimos de <code>train scores</code>, <code>train epc</code> de <code>train bearoff</code>, <code>train quiz</code> de <code>train decision</code>.</p>
<h4>Los cuatro ejercicios</h4>
...
<p>Mientras la pregunta espera su respuesta, el panel Análisis queda tapado: lleva la respuesta.</p>
<h4>Responder</h4>
...
<tr>
<td>train</td>
<td>Abre el panel Entrenamiento. Con un argumento, abre y arranca: <code>train scores</code> (la ficha de puntuación de un marcador sorteado; <code>train tp</code> y <code>train takepoint</code> son sinónimos), <code>train pips</code> (el recuento de fichas de ambos bandos), <code>train bearoff</code> (el EPC de ambos bandos en una posición generada; <code>train epc</code> es un sinónimo), <code>train decision</code> (una decisión analizada de la lista recorrida: el movimiento se juega en el tablero, la acción de cubo se elige en el panel; <code>train quiz</code> es un sinónimo).</td>
</tr>
<tr>
<td>tp2</td>
