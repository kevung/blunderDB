...
<h3>Panel Anki</h3>
<p>El panel <strong>Anki</strong> (<em>CTRL-K</em>) permite estudiar mediante repetición espaciada, utilizando el algoritmo FSRS. Una carta plantea una pregunta: casi siempre una posición, tomada de una colección o de una búsqueda; también puede ser un marcador.</p>
...
<p><strong>Repaso:</strong> Seleccione un mazo y luego haga clic en <em>Study</em> (o haga doble clic en un mazo) para empezar a repasar las cartas pendientes. Una carta de posición muestra la posición en el tablero; una carta de marcador anuncia el marcador y deja el tablero tal como está. Evalúe su recuerdo con las teclas <em>1</em> (Repetir), <em>2</em> (Difícil), <em>3</em> (Bien) o <em>4</em> (Fácil). Pulse <em>Esc</em> para detenerse y volver a la lista de mazos.</p>
...
<p><strong>Mostrar la respuesta:</strong> La carta plantea una pregunta — qué jugada jugar, qué acción de cubo, o qué números lleva un marcador. Reflexione y luego pulse <em>ESPACIO</em> (o haga clic en la zona oculta) para desvelar la respuesta: el análisis registrado de la posición, tal como lo presenta la pestaña Análisis, o la ficha del marcador, entera. En una ficha no hay nada que marcar: Anki planifica una memoria, no mide un cálculo — las faltas las cuenta el Entrenamiento. Aparece bajo los botones de evaluación, que permanecen en su sitio y al alcance. Hacer clic en una jugada de la lista la muestra en el tablero.</p>
...
<p><strong>Registro de repasos.</strong> En los Ajustes de un mazo, el botón <em>Registro de repasos</em> muestra lo que se le <strong>dijo</strong> al planificador — fecha, tema (el número de la posición, o el marcador), nota, estado, intervalo concedido — frente a lo que planea. Es el único sitio donde se ve una nota introducida por error. Allí no se corrige: la programación queda fuera de alcance, y esa regla es justamente lo que hace útil el registro — el pasado no se reescribe, pero se puede conocer.</p>
...
<p>El panel <strong>Anki</strong> repasa lo que se <strong>retiene</strong>; el panel <strong>Entrenamiento</strong> ejercita lo que se <strong>calcula</strong>, contra el reloj. Se abre con <code>CTRL-J</code>, con el botón de la barra de herramientas situado justo después de « Position aléatoire », o con la orden <code>train</code>. La ficha de marcador pertenece a los dos: aquí se calcula y en un mazo de fichas de marcador se retiene.</p>
