...
<p>
    評価パネルを開くには、<strong>Ctrl+E</strong> を押すか、下部パネルの評価タブをクリックするか、コマンドラインに <strong>epc</strong> と入力します。ボードは標準的な ベアオフ構成（15
    チェッカー）で初期化されます。
</p>
<p>マウスを使ってホームボードのポイント上のチェッカーを自由に追加または削除できます。EPC 値は専用の評価パネルにリアルタイムで表示され、各プレイヤーについて次を表示します:</p>
<ul>
