...
<p>Reinserire i due dadi nella cella di <strong>apertura</strong> di una partita decide di nuovo chi comincia: il dado del giocatore 1 si digita per primo, quello del giocatore 2 dopo, e vince il più alto — il dado grande per primo, il turno va al giocatore 1, in basso sulla tavola; il piccolo per primo, va al giocatore 2, in alto. La convalida è immediata al secondo dado, come per un'apertura nuova. La prima mossa di pedine della partita, invece, conserva il campo che aveva: se ora spetta all'altro giocatore, la trascrizione la segnala e il cursore vi si posa, dove <em>s</em> la dà al campo giusto.</p>
...
<td>Reinserire il lancio d'apertura: dado del giocatore 1 e poi del giocatore 2, registrati al secondo dado. Vince il più alto — il dado grande per primo, il turno va al giocatore 1 in basso; il piccolo per primo, al giocatore 2 in alto.</td>
</tr>
<tr>
<td>GIÙ, j</td>
