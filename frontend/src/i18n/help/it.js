    ...
    commands: `
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>tutorial, tour</td>
                                <td>Apri il catalogo delle visite guidate dell'interfaccia</td>
                            </tr>
                            <tr>
                                <td>demo</td>
                                <td>Carica un database di esempio (partite, torneo, analisi) per scoprire lo strumento</td>
                            </tr>
                            <tr>
                                <td>stats, st</td>
                                <td>Mostra/nascondi il pannello statistiche</td>
                            </tr>
                            <tr>
                                <td>blunders, bl [n]</td>
                                <td>Carica i peggiori errori (equity/MWC) nella vista di analisi, secondo il filtro statistiche corrente (predefinito 10; es. <em>bl 50</em> per 50)</td>
                            </tr>
                            <tr>
                                <td>met</td>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>D1</td>
                                <td>Includi la tirata di dadi solo sul primo dado (il suo valore appare su uno dei due dadi della posizione)</td>
                            </tr>
                            <tr>
                                <td>xD65</td>
                                <td>Escludi le posizioni giocate con la tirata 6-5, indipendentemente dall'ordine (ripetibile per escludere più tirate: <em>xD65 xD54</em>)</td>
                            </tr>
                            <tr>
                                <td>nc</td>
                            ...
                            <tr>
                                <td>fl</td>
                                <td>La posizione è stata contrassegnata (<em>flag</em>) nel software di origine, durante l'importazione di una partita eXtreme Gammon</td>
                            </tr>
                            <tr>
                                <td>x</td>
                                <td
                            ...
                            <tr>
                                <td>co</td>
                                <td>La posizione porta un commento, qualunque ne sia il contenuto</td>
                            </tr>
                            <tr>
                                <td>xco</td>
                                <td>La posizione non porta alcun commento</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>idx</td>
                                <td>Cerca la posizione con ID x (es. id12)</td>
                            </tr>
                            <tr>
                                <td>idx,y</td>
                                <td>Cerca le posizioni con ID da x a y (es. id5,10)</td>
                            </tr>
                            <tr>
                                <td>pl'nom'</td>
                                <td>Cerca le posizioni di una partita a cui ha partecipato il giocatore indicato, su entrambi i lati (es. pl'Alice'). Non distingue maiuscole/minuscole</td>
                            </tr>
                        </tbody>
                    </table>
                    <h3>Varie</h3>
...
`,
    about: `
                    ...
                    <ul>
                        <li>La rete neurale <strong>strehl-prob5-512-512-256-128</strong> è opera di <strong>Alexander Strehl</strong> (<em>alexstrehl/backgammon-ai-engine</em>, MIT). La ricerca, il modello di cubo e la tabella di match equity che la circondano costituiscono la configurazione propria di <strong>gammonNet</strong> (<a href="https://github.com/kevung/gammonNet" target="_blank" rel="noopener noreferrer">github.com/kevung/gammonNet</a>, MIT).</li>
                        ...
                        <li>I database di bearoff a un lato (6 punti, 15 pedine, per l'EPC) e a due lati (6 punti, 6 pedine, per i verdetti di cubo nelle corse) sono stati generati con <strong>GNU Backgammon</strong> (GNUbg). GNUbg è software libero sotto licenza GPL; queste tabelle sono dati da esso prodotti, accreditati come tali.</li>
                        <li>I file di match sono letti da <em>xgparser</em> e <em>gnubgparser</em> (LGPL-2.1) e da <em>bgfparser</em> (MIT).</li>
                    ...
                    <p>L'inventario completo, con il testo delle licenze, è il file <strong>THIRD_PARTY.md</strong> distribuito con blunderDB (<a href="https://github.com/kevung/blunderDB/blob/main/THIRD_PARTY.md" target="_blank" rel="noopener noreferrer">github.com/kevung/blunderDB</a>).</p>
`
};
