...
<p>
    Il calcolatore EPC (Effective Pip Count) calcola il pip count effettivo delle posizioni di bearoff. Utilizza il database di bearoff a un lato a 6 punti di GNUbg per ottenere valori di EPC esatti.
</p>
<p>
    Per aprire il pannello Eval, premi <strong>Ctrl+E</strong>, fai clic sulla scheda Eval del pannello inferiore o digita <strong>epc</strong> nella riga di comando. Il tavoliere viene inizializzato
    con una configurazione standard di bearoff (15 pedine).
</p>
<p>
    Puoi aggiungere o rimuovere liberamente pedine sui punti del proprio quadrante interno con il mouse. I valori di EPC vengono mostrati in tempo reale nel pannello Eval dedicato, indicando per
    ciascun giocatore:
</p>
<ul>
...
<p>
    Su una posizione di bearoff pura, una tabella di corsa mostra inoltre le probabilità di vittoria di entrambi i giocatori e, quando la posizione è coperta da un database two-sided (integrato fino a
    6 pedine per giocatore, database esteso scaricabile fino a 11 dalla scheda Bearoff delle impostazioni), le equità money esatte — con, sotto ogni decisione non ottimale, lo scarto di equità dalla
    migliore — e la migliore decisione del cubo. Fuori da questo dominio la probabilità è stimata (badge «stimato» con il margine d'errore) e nessuna decisione viene mostrata. Il giocatore al tiro si
    modifica cliccando il rettangolo bearoff/punteggio di un giocatore, la posizione del cubo cliccando il cubo.
</p>
