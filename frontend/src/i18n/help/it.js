...
<ul>
<li>l'<strong>esercizio</strong> — <em>Scores</em>, <em>Pions</em> (conteggio), <em>Bearoff</em> o <em>Décision</em>;</li>
...
<p><code>train scores</code>, <code>train pips</code>, <code>train bearoff</code> e <code>train decision</code> aprono il pannello e avviano direttamente; <code>train tp</code> e <code>train takepoint</code> sono sinonimi di <code>train scores</code>, <code>train epc</code> di <code>train bearoff</code>, <code>train quiz</code> di <code>train decision</code>.</p>
<h4>I quattro esercizi</h4>
...
<p>Finché la domanda attende la sua risposta, il pannello Analisi resta mascherato: porta la risposta.</p>
<h4>Rispondere</h4>
...
<tr>
<td>train</td>
<td>Apre il pannello Allenamento. Con un argomento, apre e avvia: <code>train scores</code> (la scheda di punteggio di un punteggio estratto a sorte; <code>train tp</code> e <code>train takepoint</code> sono sinonimi), <code>train pips</code> (il conteggio delle pedine dei due lati), <code>train bearoff</code> (l'EPC dei due lati su una posizione generata; <code>train epc</code> è un sinonimo), <code>train decision</code> (una decisione analizzata della lista sfogliata: la mossa si gioca sulla tavola, l'azione di cubo si sceglie nel pannello; <code>train quiz</code> è un sinonimo).</td>
</tr>
<tr>
<td>tp2</td>
