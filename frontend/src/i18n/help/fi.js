...
<ul>
<li><strong>harjoitus</strong> — <em>Scores</em>, <em>Pions</em> (pip-laskenta), <em>Bearoff</em> tai <em>Décision</em>;</li>
...
<p><code>train scores</code>, <code>train pips</code>, <code>train bearoff</code> ja <code>train decision</code> avaavat paneelin ja aloittavat suoraan; <code>train tp</code> ja <code>train takepoint</code> ovat <code>train scores</code>:n synonyymejä, <code>train epc</code> on <code>train bearoff</code>:n ja <code>train quiz</code> <code>train decision</code>:n synonyymi.</p>
<h4>Neljä harjoitusta</h4>
...
<p>Kun kysymys odottaa vastaustaan, analyysipaneeli pysyy peitettynä: se kantaa vastauksen.</p>
<h4>Vastaaminen</h4>
...
<tr>
<td>train</td>
<td>Avaa Harjoittelu-paneelin. Argumentin kanssa se avaa ja aloittaa: <code>train scores</code> (arvotun tilanteen pistekortti; <code>train tp</code> ja <code>train takepoint</code> ovat synonyymejä), <code>train pips</code> (molempien osapuolten pip-laskenta), <code>train bearoff</code> (molempien osapuolten EPC luodussa asemassa; <code>train epc</code> on synonyymi), <code>train decision</code> (analysoitu päätös selattavasta luettelosta: siirto pelataan laudalla, kuutiopäätös valitaan paneelissa; <code>train quiz</code> on synonyymi).</td>
</tr>
<tr>
<td>tp2</td>
