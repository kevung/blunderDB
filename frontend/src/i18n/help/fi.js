...
<p>Kaksi asetusta ohjaa <strong>naapuriasemien</strong> järjestämistä (tunnus <code>like</code>, ks. Hakupaneeli): palautettavien naapureiden määrä ja enimmäisetäisyys, jonka takana asema lakkaa olemasta naapuri. Tämä etäisyys on oletuksena nolla, siis ilman kattoa: mittakaava riippuu pelin vaiheesta, ja tässä valittu arvo luettaisiin mittaukseksi. Tunnus <code>like&lt;12</code> asettaa omansa yhtä hakua varten, asetukseen koskematta.</p>
...
<h3>Roskakori</h3>
<p>Aseman, kokoelman tai kommentin poisto kulkee <strong>roskakorin</strong> kautta: poisto todella tapahtuu, mutta kopio katoavasta säilytetään kolmekymmentä päivää. Komento <code>trash</code> avaa ikkunan, joka listaa ne, kussakin <em>Palauta</em> ja <em>Poista</em>.</p>
...
<p>Kahden nopan syöttäminen uudelleen pelin <strong>avaussoluun</strong> ratkaisee uudestaan, kumpi aloittaa: pelaajan 1 noppa kirjoitetaan ensin, pelaajan 2 noppa sen jälkeen, ja suurempi voittaa — iso noppa ensin, vuoro menee pelaajalle 1 laudan alalaidassa; pieni ensin, se menee pelaajalle 2 ylälaidassa. Vahvistus tapahtuu heti toisella nopalla, kuten uudessa avauksessa. <strong>Pelin ensimmäinen nappulasiirto seuraa uutta voittajaa</strong> ja vaihtaa saraketta sen mukana: sen puolta ei ollut valittu, avaus ehdotti sen — heiton voittaja pelaa molemmat nopat syöttämättä niitä uudelleen. Se on ainoa toiminto, jonka avauksen korjaus siirtää: loppupeli säilyttää puolensa, eikä <em>s</em>-näppäimellä jo toiselle pelaajalle annettua siirtoa oteta takaisin.</p>
...
<p>Ehdotus vahvistetaan <strong>yhdellä napsautuksella</strong> <em>Aloita</em>-painikkeesta. <strong>Aloita kaikki</strong> vahvistaa koko listan kahdella napsautuksella, näytettyään sen ensin; <em>Vahvista</em> on tuon listan alussa. ”Ohita toistaiseksi” ei kirjoita mitään: moottori on deterministinen, ja ehdotus palaa samanlaisena seuraavalla kerralla. <em>Muodosta pari käsin</em> on aina tarjolla — moottori ehdottaa, johtaja päättää.</p>
<p>Käsin paritettu ottelu ilman pöytänumeroa saa ensimmäisen vapaan pöydän. Jos sali on täynnä, ottelu käynnistetään silti, ja sen ruutu näkyy ruudukon lopussa merkinnällä ”ei pöytää”, kunnes se siirretään pöytään.</p>
...
<p><strong>Sijoitukset</strong>-välilehti näyttää nykyiset sijoitukset osio kerrallaan, palkintoineen jos palkintopotti on asetettu. Kaksi tasapisteissä olevaa jakavat sijan ja palkinnon. <strong>Päätä turnaus</strong> lukitsee loppusijoituksen. Sijoitukset kopioidaan CSV:nä käyttöliittymän kielellä tai tallennetaan tiedostoon: <strong>Tallenna…</strong> avaa järjestelmän valintaikkunan ehdotetulla nimellä, turnaus sekä sana ”sijoitukset” ja päivän päivämäärä, ja tiedosto sisältää täsmälleen kopioidun CSV:n. Komentorivillä <code>blunderdb tournament standings</code> kirjoittaa saman CSV:n.</p>
<p>Päättäminen ilman käynnissä olevia otteluita on yksi napsautus. Jos otteluita on käynnissä, Sarjataulukko kertoo niiden määrän ja odottaa toista napsautusta paikan päällä: päättäminen jäädyttää sarjataulukon ilman niitä, eikä niiden tulosta voi enää kirjata. <strong>Avaa uudelleen</strong> vahvistetaan samalla tavalla; lopullinen sarjataulukko lakkaa silloin olemasta lopullinen, ja uudelleenavaus jää lokiin.</p>
...
<p>Asetukset pysyvät saatavilla <strong>turnauksen aikana</strong>: vaihtorajan laskeminen kello 22 aikaisemman lopetuksen vuoksi, lohdutuskaavion lisääminen lauantai-iltana, niin kauan kuin kaavion arvontaa ei ole tehty. Se, mikä silloin on lukittu, näkyy harmaana perusteluineen: avatun vaiheen muoto, sen jakamien elämien määrä ja vaiheen arvonnasta alkaen sen lohdutuskaavio, sovittelu, lataus, lohkojen koko ja jatkoon pääsevien määrä. Tallentaminen kesken turnauksen näyttää ensin listan siitä, mikä muuttuu, ja pyytää vahvistuksen.</p>
...
<ul>
<li><strong>harjoitus</strong> — <em>Scores</em>, <em>Pions</em> (pip-laskenta), <em>Bearoff</em>, <em>Évaluation</em> tai <em>Décision</em>;</li>
...
<p>Kun Harjoittelu-paneelin kysymys on esitetty laudalla, luetteloa selaavat näppäimet eivät vieritä sitä: kysymys pitää laudan.</p>
<h3>Näyttö</h3>
<table>
<thead>
<tr>
...
<tr>
<td>1 … 6 (kohdistin pelin avauksessa)</td>
<td>Syötä avausheitto uudelleen: pelaajan 1 noppa ja sitten pelaajan 2, kirjataan toisen nopan kohdalla. Suurempi voittaa — iso noppa ensin, vuoro menee alhaalla olevalle pelaajalle 1; pieni ensin, ylhäällä olevalle pelaajalle 2. Pelin ensimmäinen nappulasiirto seuraa uutta voittajaa.</td>
</tr>
<tr>
<td>ALAS, j</td>
