...
<p>L'onglet <strong>Classement</strong> montre le classement courant, section par section, avec les prix lorsqu'une dotation est réglée. Deux ex æquo partagent la place et le prix. <strong>Clore le tournoi</strong> fige le classement final. Le classement se copie en CSV, dans la langue de l'interface, ou s'enregistre dans un fichier : <strong>Enregistrer…</strong> ouvre le dialogue du système sur un nom proposé, le tournoi suivi du mot « classement » et de la date du jour, et le fichier contient exactement le CSV copié. En ligne de commande, <code>blunderdb tournament standings</code> écrit le même CSV.</p>
