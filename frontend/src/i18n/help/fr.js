...
<ul>
<li>l'<strong>exercice</strong> — <em>Scores</em>, <em>Pions</em>, <em>Bearoff</em> ou <em>Décision</em> ;</li>
...
<p><code>train scores</code>, <code>train pips</code>, <code>train bearoff</code> et <code>train decision</code> ouvrent le panneau et démarrent directement ; <code>train tp</code> et <code>train takepoint</code> sont des synonymes de <code>train scores</code>, <code>train epc</code> de <code>train bearoff</code>, <code>train quiz</code> de <code>train decision</code>.</p>
<h4>Les quatre exercices</h4>
...
<p>Tant que la question attend sa réponse, le panneau Analyse est masqué : il porte la réponse.</p>
<h4>Répondre</h4>
...
<tr>
<td>train</td>
<td>Ouvre le panneau Entraînement. Avec un argument, ouvre et démarre : <code>train scores</code> (la fiche de score d'un score tiré au sort ; <code>train tp</code> et <code>train takepoint</code> sont des synonymes), <code>train pips</code> (le compte de pions des deux camps), <code>train bearoff</code> (l'EPC des deux camps sur une position engendrée ; <code>train epc</code> est un synonyme), <code>train decision</code> (une décision analysée de la liste parcourue : le coup se joue sur le plateau, l'action de videau se choisit dans le panneau ; <code>train quiz</code> est un synonyme).</td>
</tr>
<tr>
<td>tp2</td>
