...
<p>Se règlent ici : les phases et leur longueur de match, les longueurs tour par tour d'un tableau (« 15, 13, 11 » se lit du dernier tour vers le premier), le nombre de tables, le rythme prévu en minutes par point (8 par défaut ; la bande d'horloge et la fin estimée en partent), les pauses de la journée, la dotation (droit d'entrée, retenue du club, barème par section) et le dossier d'affichage.</p>
