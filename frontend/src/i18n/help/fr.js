...
<p>Une proposition se confirme d'<strong>un clic</strong> sur <em>Lancer</em>. <strong>Tout lancer</strong> confirme la file entière en deux clics, après en avoir montré la liste ; <em>Confirmer</em> est en tête de cette liste. « Ignorer pour l'instant » n'écrit rien : le moteur est déterministe, et la proposition revient identique au prochain appel. <em>Apparier à la main</em> reste offert en permanence — le moteur propose, le directeur décide.</p>
